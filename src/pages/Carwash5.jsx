...
const Carwash5 = () => {
  const checklist = [
    ...
    {
      text: "Includes vacuuming and tyre polishing",
      isChecked: true,
    },
    {
  ...
  return (
    <div className="w-full min-h-screen bg-white lg:-translate-y-44  text-black flex flex-col md:flex-row space-y-px md:space-x-px">
